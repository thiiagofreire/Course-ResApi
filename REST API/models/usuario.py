...
MAILGUN_DOMAIN = 'sandboxa1c329ae8b9c4549a5810ab8a4192d82.mailgun.org'
MAILGUN_API_KEY = '7188713b5f9cbbd2c75d63173630e373-262b213e-bf160a3e'
FROM_TITLE = 'NO-REPLY'
FROM_EMAIL = 'no-reply@restapi.com'
class UserModel(banco.Model):  #classe
    ...
    def send_confirmation_email(self):
        ...
        link = request.url_root[:-1] + url_for('userconfirm', user_id=self.user_id) #/confirmacao/{user_id}]
